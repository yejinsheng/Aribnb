        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="place"> 
                        <button data-city="101" @click="buttonShow($event)">重庆</button>
                        <button data-city="102" @click="buttonShow($event)">北京</button>
                        <button data-city="103" @click="buttonShow($event)">杭州</button>
                        <button data-city="104" @click="buttonShow($event)">成都</button>
                        <button data-city="501" @click="buttonShow($event)">伦敦</button>
                        <button data-city="105" @click="buttonShow($event)">台北</button>
                        <button data-city="301" @click="buttonShow($event)">东京</button>
                        <button data-city="201" @click="buttonShow($event)">巴黎</button>
                    </div>
                </div>
                <div class="col-12">
                    <div class="row" id="hotPlace">
                        <div class="col-md-4 col-6 mt-3 pr-0">
				<!-- <img class="w-100" src=""/> -->
				...
				<img src="" class="rounded-circle ml-1 xiang">
				</div>
				</div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods:{
            buttonShow(e){
                ...
                console.log(cityid)
                this.axios.get("/app/index/getIndex?cityid=" + this.cityid).then(res => {this.obj = res.data;});
            }
        }
    }
</script>
...
#d2{
    ...
    width:100%;
    background-image:url("http://localhost:8000/img/41df549a-66b9-4202-bde0-31941e58c063.jpg");
...
#sincere{
    width: 100%;
    background-image: url("http://localhost:8000/img/e36e06a9-f9a4-49a5-a94c-02134a8787c5.jpg");
    background-repeat: no-repeat;
    height: 344px;
    position: relative;
}
